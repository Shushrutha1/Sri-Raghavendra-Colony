...
// Fetch plot number from the form input
$plotno = isset($_POST['plotno']) && !empty($_POST['plotno']) ? $_POST['plotno'] : '';

// Fetch all records based on the selected plot number
$query = "SELECT * FROM receipts WHERE plotno='$plotno' AND status=1 ORDER BY rno";
    ...
    <div class="content-page">
        <div class="content">
            <div class="container-fluid">
                <h1 class="page-title">Receipt Report by Plot Number</h1>
                <!-- Form for selecting plot number -->
                <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data" class="noprint">
                    <!-- Dropdown for selecting plot number -->
                    <label for="plotno">Plot Number:</label>
                    <input type="text" name="plotno" id="plotno" required>
                    <!-- Submit Button -->
