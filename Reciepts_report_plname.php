...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // Fetch and sanitize plot name
    $plname = isset($_POST['plname']) ? trim($_POST['plname']) : '';
    
    if (!empty($plname)) {
        // Use prepared statements to prevent SQL injection
        $query = "SELECT * FROM receipts WHERE plname LIKE ? AND status=1 ORDER BY rno";
        ...
        echo "<p style='color: red;'>Please enter a valid plot name.</p>";
    }
}
?>
    ...
    <div class="content-page">
        <div class="content">
            <div class="container-fluid">
                <h1 class="page-title">Receipt Report by Plot Name</h1>
                <!-- Form for selecting plot name -->
                <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data" class="noprint">
                    <!-- Dropdown for selecting plot name -->
                    <label for="plname">Plot Name:</label>
