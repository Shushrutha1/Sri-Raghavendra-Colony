...
$rno = isset($_POST['rno']) && !empty($_POST['rno']) ? $_POST['rno'] : '';

// Fetch all records based on the selected receipt number
$query = "SELECT * FROM receipts WHERE rno='$rno' AND status=1 ORDER BY rno";
    ...
    <div class="content-page">
        <div class="content">
            <div class="container-fluid">
                <h1 class="page-title">Receipt Report by Receipt No</h1>
