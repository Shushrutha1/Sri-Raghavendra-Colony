...
$query = "SELECT * FROM receipts WHERE month='$month' AND year='$year' AND status=1 ORDER BY rno";
    ...
    <div class="content-page">
        <div class="content">
            <div class="container-fluid">
                <h1 class="page-title">Receipt Report by Month and Year</h1>
                ...
                <form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" enctype="multipart/form-data" class="noprint">
                    ...
                    <select name="year" id="year" required>
                        ...
                        $yearQuery = "SELECT DISTINCT year FROM receipts ORDER BY year DESC";
