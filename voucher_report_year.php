...
// Query to get distinct years from the voucher table
$yearQuery = "SELECT DISTINCT year FROM voucher WHERE status = 1 ORDER BY year DESC";
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($selectedYear !== '') {
        ...
        $query = "SELECT * FROM voucher WHERE year = ? AND status = 1 ORDER BY vno";
                ...
                <table id="voucherdata" border="1" cellpadding="10" class="table table-bordered">
                    <thead>
                        <tr>
                            ...
                            <th>Pay Mode</th>                        
                            <th>Date</th>
                            <th>Month</th> <!-- Month column reintroduced -->
                            <th>Year</th>
                            <th>Amount</th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        foreach ($vouchers as $voucher): ?>
                            <tr>
                                ...
                                <td><?= $voucher['month'] ?></td> <!-- Display Month -->
                                <td><?= $voucher['year'] ?></td>
